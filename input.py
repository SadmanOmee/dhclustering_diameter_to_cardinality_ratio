...
#points2 = np.random.gamma(2.0, 2.0, size=[400, 2])
#points = np.random.pareto(3.0, size=[800, 2])
...
for i in range (0, len(points)):
    ...
    #xCoordinates.append(points2[i][0] + 9)
    #yCoordinates.append(points2[i][1] + 9)
    #inp = str(points2[i][0] + 9) + " " + str(points2[i][1] + 9) + "\n"
    #file.write(inp)
